...
module.exports = (router) => {
  ...
  router.route('/cliente')
    .post(
      asyncMiddleware(validaDTO('body', {
      ...
      asyncMiddleware(clienteController.listarTodosClientes)
    )

  router.route('/cliente/:clienteid')
    .get(
      asyncMiddleware(autorizacaoMiddlewate('PESQUISA_CLIENTE_ID')),
      validaDTO('params', {
      ...
      asyncMiddleware(clienteController.pesquisaPorId)
    )
